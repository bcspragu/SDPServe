...
public class Piano {
	public static MidiChannel[] channels;		//Channels the piano will play on
	
	public static void play_Chord(int[] notes, int velocity, int duration) throws InterruptedException {
			
		//Play 4 note chords
		channels[0].noteOn( notes[0], velocity );
		channels[1].noteOn( notes[1], velocity );
		channels[2].noteOn( notes[2], velocity );
		channels[3].noteOn( notes[3], velocity );
		//Async method call here
